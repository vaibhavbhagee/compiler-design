...
%type <node> translation_unit external_declaration declaration declaration_specifiers storage_class_specifier 
...
external_declaration
	: function_definition 						{treeNode temp = treeNode("ext"); temp.children.push_back(*$1); $$ = &temp;}
	| declaration 								{treeNode temp = treeNode("ext"); temp.children.push_back(*$1); $$ = &temp;}
	;
